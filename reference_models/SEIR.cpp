...
NumericVector transmission_calc_ER_SEIR (NumericVector y, NumericMatrix Contact_Structure, int num_grps, float bR)
{
...
NumericVector transmission_calc_EI_SEIR (NumericVector y, NumericMatrix Contact_Structure, int num_grps, float bI)
{
  //initialise output vector
...
float seasonal_other_SEIR (double year_time, float amplitude, float baseline,
...
//[[Rcpp::export]]
List SEIR_2virus_cons (double t, NumericVector y, List parms)
{
  ...
  NumericMatrix Contact_Structure = parms["contacts_all"] ;
  ...
  bI = seasonal_other_SEIR(t,amplitude, bI, phi, gammaI);
//Rcout << bI << "/n";
  ...
  N = sum(y) - counters ;
//  Rcout << N << "\n";
  NumericVector transmission_R = transmission_calc_ER_SEIR (y, Contact_Structure,num_grps,bR);
  NumericVector transmission_I = transmission_calc_EI_SEIR (y, Contact_Structure,num_grps,bI);
